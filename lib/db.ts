...
// Always connect to RMSDatabase (cold-violet-43459769).
// The hardcoded string ensures the app works even if DATABASE_URL is missing or wrong.
const url =
  process.env.DATABASE_URL?.includes("cold-violet") || process.env.DATABASE_URL?.includes("curly-scene")
